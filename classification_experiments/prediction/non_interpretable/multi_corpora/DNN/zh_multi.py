    ...
    for n_fold in range(1, 11):
      ...
      #  normalized_train_pitt, y_train_pitt = normalize_train_set(data_fold_pitt)
       ...
       # Xtrain = np.concatenate([normalized_train_zh], axis=0)
        Xtrain = np.concatenate([normalized_train_china, normalized_train_nls, normalized_train_zh], axis=0)
        y_train = np.concatenate([y_train_china, y_train_nls, y_train_zh], axis=0)
