...
for feat_name in feats_names:
    ...
    for fold in all_folds_info:
        ...
        for speaker in fold:
            ...
            all_augmented_copies3 = [os.path.join(feat_pths_augmented3, feat_name, speaker_name + f'-{num}.npy') for num in all_copies]
            all_augmented_copies4 = [os.path.join(feat_pths_augmented4, feat_name, speaker_name + f'-{num}.npy') for num  in all_copies]
