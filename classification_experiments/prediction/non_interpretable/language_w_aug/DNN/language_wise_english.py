# feats_names =
feats_names = ['gpt4', 'lealla-base', 'XLM-Roberta-Large-Vit-L-14',
...
out_path = '/export/b01/afavaro/INTERSPEECH_2024/TAUKADIAL-24/training/results_training/results_per_language/english/prediction/non_interpretable_sigmoid/'
...
for feat_name in feats_names:
    ...
    for fold in all_folds_info:
        ...
        for speaker in fold:
            ...
            all_copies = [0, 1, 2, 3]
            all_augmented_copies = [os.path.join(feat_pths_augmented, feat_name, speaker_name + f'-{num}.npy') for num
                                    in all_copies]
