...
for cv_num in cv_range:
    ...
    cv_train1 = pd.read_csv(f'/export/b01/afavaro/INTERSPEECH_2024/TAUKADIAL-24/training/finetuning/data/augmented_gpt/chinese/cv_{cv_num}/train.csv')
    cv_train1 = cv_train1.drop(columns=['Unnamed: 0'])
    cv_train1['label'] = ['MCI' if elem == 0 else 'CN' for elem in list(cv_train1['label'])]

    cv_train2 = pd.read_csv(f'/export/b01/afavaro/INTERSPEECH_2024/TAUKADIAL-24/training/finetuning/data/augmented_gpt/chinese/cv_{cv_num}/dev.csv')
    ...
    cv_test = pd.read_csv(f'/export/b01/afavaro/INTERSPEECH_2024/TAUKADIAL-24/training/finetuning/data/augmented_gpt/chinese/cv_{cv_num}/test.csv')
